			...
			<div class="card-body">
				...
				<div class="card" id="filter_inputs">
					<div class="card-body pb-0">
						<form action="<?php echo base_url('reports/feedReports')?>" method="GET">
							<div class="row">
					...
					<table class="table datanew">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo number_format($key['usedQty'] * $key['unit_cost'], 2)?></td>
								<td>
