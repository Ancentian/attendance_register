            ...
            <div class="col-md-12">
                <div class="card bg-white">
                    <div class="card-header">
                        <h5 class="card-title">Training Attendance Reports</h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            ...
                                                            <a href="<?php echo base_url('reports/attendanceList/'.$key->id."/".$key->cooperative_id."/".$key->clusterID."/".$key->training_id) ?>" title="View Attendance" class="btn btn-sm bg-danger-light">
