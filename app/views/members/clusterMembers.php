    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Cluster Members</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('home/index')?>">Dashboard</a></li>
                        <li class="breadcrumb-item active"><?php echo $members[0]['cluster_name']?> Members</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card card-table">
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title"><?php echo $members[0]['cluster_name'] ?> Cluster Members</h3>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 star-student table-hover table-center mb-0  table-striped" id="example">
                                ...
                                <tbody>
                                    ...
                                    <td><?php echo ucfirst($key['cluster_name'])?></a></td>
                                    ...
                                    <td class="text-end">
                                        <div class="actions">
                                            <a href="<?php echo base_url('members/editMember?memberID='. $key['id_number'])?>" title="View Member" class="btn btn-sm bg-success-light me-2">
