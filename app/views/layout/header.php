...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>res/assets/css/bootstrap-datetimepicker.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>res/assets/plugins/datatables/datatables.min.css">
