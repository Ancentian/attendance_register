                                        ...
                                        <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                            ...
                                            <tbody>
                                                <?php $i=1; foreach($schedules as $key) {?>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td> <a href="<?php echo base_url('training/mark_trainingAttendance/'.$key->training_id."/".$key->cooperative_id."/".$key->clusterID) ?>" style="color: blue;" onmouseover="this.style.color='red';" onmouseout="this.style.color='blue';"><?php echo strtoupper($key->training_name) ?></a></td>
                                                        <td><?php echo $key->cooperative_name?></td>
                                                        <td><?php echo $key->cluster_name?></td> 
                                                        <td><?php echo $key->training_date?></td>
                                                        <td><?php echo $key->first_name." ".$key->last_name?></td>
                                                        <!-- <td class="text-end" hidden>
                                                            <div class="actions">
                                                                <a href="<?php //echo base_url('training/attendanceList/'.$key->training_id."/".$key->cooperative_id."/".$key->clusterID)?>" title="View Attendance" class="btn btn-sm bg-success-light me-2" id="attendanceLink"><i class="feather-eye"></i></a>

                                                                <a href="<?php //echo base_url('training/trainingAttendance/'.$key->training_id."/".$key->cooperative_id."/".$key->clusterID) ?>" class="btn btn-sm bg-danger-light">
